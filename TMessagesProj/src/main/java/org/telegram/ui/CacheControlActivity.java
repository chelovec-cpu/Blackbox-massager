...
import com.blackbox.messenger.CacheByChatsController;
import com.blackbox.messenger.Emoji;
import com.blackbox.messenger.FileLoader;
import com.blackbox.messenger.FileLog;
import com.blackbox.messenger.FilePathDatabase;
import com.blackbox.messenger.FilesMigrationService;
...
//            loadDialogEntities();
    ...
    class CacheChartHeader extends FrameLayout {
        ...
        public CacheChartHeader(Context context) {
            ...
            for (int i = 0; i < 3; ++i) {
                ...
                if (i == 0) {
                    ...
                    subtitle[i].setText(LocaleController.getString(R.string.StorageUsageBlackbox Messenger));
        ...
        public void setData(boolean hasCache, float percent, float usedPercent) {
            ...
            if (hasCache) {
                if (percent < 0.01f) {
                    subtitle[1].setText(formatString(R.string.StorageUsageBlackbox MessengerLess, formatPercent(percent)));
                } else {
                    subtitle[1].setText(formatString(R.string.StorageUsageBlackbox Messenger, formatPercent(percent)));
                }
                switchSubtitle(1);
            } else {
                switchSubtitle(2);
