...
public class DatabaseMigrationHint extends FrameLayout {
    ...
    public DatabaseMigrationHint(Context context, int currentAccount) {
        ...
        title.setText(LocaleController.getString(R.string.OptimizingBlackbox Messenger));
        ...
        description1.setText(LocaleController.getString(R.string.OptimizingBlackbox MessengerDescription1));
        ...
        description2.setText(LocaleController.getString(R.string.OptimizingBlackbox MessengerDescription2));
