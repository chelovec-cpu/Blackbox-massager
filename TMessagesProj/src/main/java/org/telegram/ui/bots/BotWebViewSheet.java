...
import com.blackbox.messenger.BotFullscreenButtons;
...
//        }
    ...
    public void setFullscreen(boolean fullscreenF, boolean animated, boolean blur) {
        final boolean fullscreen = com.blackbox.messenger.MessagesController.getGlobalMainSettings().getBoolean("botSkipFullscreen", false)
            ? false
            : fullscreenF;
